...
Вполнили изменения в двух файлах, но  в коммит добавили только один файл, а второй забыли. 

Либо добавили файл в коммит, а потом внесли еще изменения, и нужно обновить этот файл в коммите.

Тогда:

1. добавляем изменения как обычно git add

2. Используем команду git commit --amend --no-edit

С опцией --amend команда commit не создаст новый коммит, а дополнит последний, просто добавив в него новый файл. При этом хеш последнего коммита изменится, потому что изменился список файлов в коммите.
